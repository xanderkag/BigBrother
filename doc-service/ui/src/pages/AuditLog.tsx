    ...
    <div className="mx-auto max-w-6xl space-y-4 p-6">
      ...
      <div className="space-y-2">
        {!isLoading && items.length === 0 && (
          <div className="card">
            <div className="card-body text-center text-slate-400">
              Записей нет.
            </div>
          </div>
        )}
    ...
    <div className="card">
      <div className="card-body">
        <div className="flex items-center gap-3 text-sm">
          ...
          <span className="font-medium text-slate-900">{entry.entity}</span>
          ...
          <div className="mt-3 space-y-1">
            {diffEntries.slice(0, expanded ? 999 : 5).map(([field, change]) => (
              <div key={field} className="flex items-start gap-3 text-xs">
                ...
                <span className="rounded bg-rose-50 px-1.5 py-0.5 font-mono text-rose-700 line-through">
        ...
        {(entry.before || entry.after) && (
          <details className="mt-3">
            ...
            <div className="mt-2 grid gap-3 sm:grid-cols-2">
              {entry.before && (
                <div>
                  <div className="mb-1 text-xs font-medium text-slate-500">До</div>
              ...
              {entry.after && (
                <div>
                  <div className="mb-1 text-xs font-medium text-slate-500">После</div>
