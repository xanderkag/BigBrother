...
| Хвост офисных файлов (xls/doc) | в работе | 54% в нормативе, p90 575с — теперь это главный источник просрочки. SPEED-1/2/5 + COMPLEX-DEFER сгладили часть; XLSX-FAST/ANALYZE в гите за флагом `XLSX_FAST_PATH_ENABLED` (выключен), см. `docs/PARSING_RULES.md` |
