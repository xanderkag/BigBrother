...
| **3. Операционка** — multi-instance | 🟡 размороженo 2026-05-31 → MTI-1 (3 эпика) | продуктовое решение |
| **4. UX/архитектура** — UI ключи реально работают | 🟡 MTI-3 (1-2 дня) — критично, сейчас UI Providers ключ лежит мёртвым | техдолг |
