...
- **Status:** `OPEN` (To: SLAI_DEV — решение по онтологии + приём новых slug'ов)
- **Asked:** 2026-07-12
...
- **Status:** `OPEN` (To: SLAI_DEV — подтвердить политику; реализация P0 на нашей стороне независимо от ответа)
- **Asked:** 2026-07-12
- **From:** PARSDOCS_DEV → SLAI_DEV
...
- **Status:** `OPEN` (To: SLAI_DEV — контракт по мультидок-композитам)
- **Asked:** 2026-07-12
- **From:** PARSDOCS_DEV → SLAI_DEV
