> **Архивный документ.** Это описание корпоративного стенда ТАЙПИТ по состоянию на 2026-07-01
> (38 типов, HEAD `1b2b8e2`). Перенесён из корневого `README.md` 2026-07-19, когда README стал
> описывать сервис целиком. Ретроспектива и уроки внизу документа — актуальны.
> Текущее состояние сервиса — в корневом [`README.md`](../README.md).
