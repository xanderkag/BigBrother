...
Универсальный сервис обработки транспортных и бухгалтерских документов: счёт, УПД, счёт-фактура, ТТН, CMR, акт. На входе — PDF/JPG/PNG/BMP/TIFF, на выходе — структурированный JSON с реквизитами, суммами, контрагентами, готовый для загрузки в 1С / ERP / CRM.
