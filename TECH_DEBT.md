...
- **EXT-CORRESPONDENCE — класс «претензии / деловые письма» не покрыт + договоры (выявлено на боевом батче 2026-06-25, owner-decision: в техдолг).** На реальном пласте (18 доков) почти всё разложилось по существующим типам, но три не вписались:
  ...
  - `aa551d6e` — структурно **не опознан** (ни заголовка договора, ни письма, ни счёта — только инфлектированный стем «договорА»; маркеры неоднозначны).
  - `contract` (P1-1): тип есть (17 структурных ключей + llm_schema), но реальный договор не сматчил ни один (стем «договорА» без «ДОГОВОР №»/«Предмет договора»).
