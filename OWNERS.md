...
> Заместитель должен быть назначен **до подачи на приёмку** (требование Памятки v0.2+). До назначения — все обращения по проекту через owner'а.
...
Owner: Ляпустин А.Ю. (klgaigpt3@gmail.com)
Заместитель: TBD (будет назначен до приёмки)
